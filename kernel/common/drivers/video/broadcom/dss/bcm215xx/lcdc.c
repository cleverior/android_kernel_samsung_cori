...
//	lcd_pwr_on_controll(ON);  /* This is not needed in this stage. Init releasted with LCD Reset was done in bootloader */
#endif
...
#elif defined(CONFIG_BCM_LCD_ILI9341_ZANIN)
	lcd_send_cmd_sequence(power_on_seq_ili9341_zanin);	
#else
	lcd_send_cmd_sequence(power_on_seq_s6d04h0_boe);
#endif
